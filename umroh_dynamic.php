...
<head>
    ...
    <title>Paket Umroh - MIW Travel</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mb-5">
                    <h1 class="display-4 text-primary fw-bold">Paket Umroh</h1>
                    <p class="lead">Perjalanan suci yang berkesan menuju Tanah Suci</p>
                </div>
            </div>
            
            <div class="row">
                <?php foreach ($umrohPackages as $package): ?>
                    ...
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-img-top bg-gradient d-flex align-items-center justify-content-center" 
                            ...
                            <div class="text-center text-white">
                                <i class="fas fa-kaaba fa-3x mb-2"></i>
