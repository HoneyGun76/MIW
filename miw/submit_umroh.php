    ...
    try {
        ...
        if (empty($errors)) {
            ...
            $data = [
                ...
                'tanggal_pengeluaran_paspor' => !empty($_POST['tanggal_pengeluaran_paspor']) ? $_POST['tanggal_pengeluaran_paspor'] : null,
                'tanggal_habis_berlaku' => !empty($_POST['tanggal_habis_berlaku']) ? $_POST['tanggal_habis_berlaku'] : null,
                'jenis_vaksin_1' => $_POST['jenis_vaksin_1'] ?? null,
                'jenis_vaksin_2' => $_POST['jenis_vaksin_2'] ?? null,
                'jenis_vaksin_3' => $_POST['jenis_vaksin_3'] ?? null,
                'tanggal_vaksin_1' => !empty($_POST['tanggal_vaksin_1']) ? $_POST['tanggal_vaksin_1'] : null,
                'tanggal_vaksin_2' => !empty($_POST['tanggal_vaksin_2']) ? $_POST['tanggal_vaksin_2'] : null,
                'tanggal_vaksin_3' => !empty($_POST['tanggal_vaksin_3']) ? $_POST['tanggal_vaksin_3'] : null,
...
if ($success) {
    ...
    error_log("Form submission errors in submit_umroh.php: " . implode(", ", $errors));
    header("Location: form_umroh.php?errors=" . urlencode($errorMessages));
}
exit();